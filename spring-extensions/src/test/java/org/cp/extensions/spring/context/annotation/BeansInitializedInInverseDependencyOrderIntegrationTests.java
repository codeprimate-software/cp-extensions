 ...
 * @since 0.1.0
 */
@ActiveProfiles("bean-inverse-dependency-order")
@DirtiesContext
@SpringJUnitConfig
@SuppressWarnings("unused")
public class BeansInitializedInInverseDependencyOrderIntegrationTests
	...
	public void beansInitializedInInverseDependencyOrder() {
		...
		assertThat(getBeanNames())
			.describedAs("Expected [C, A, B]; but was %s", getBeanNames())
	...
	@Profile("bean-inverse-dependency-order")
	static class BeanInverseDependencyOrderedTestConfiguration {
